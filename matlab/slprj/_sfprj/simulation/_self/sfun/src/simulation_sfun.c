...
extern void sf_simulation_uses_exported_functions(int nlhs, mxArray * plhs[],
  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(613473409U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2125952669U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2122295690U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1396577850U);
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2329332282U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1169257407U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2434547187U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2834002205U);
  }
  ...
  nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "dG6vXr0YJ71uaf1qQhpDzC") == 0) {
     ...
     case 2:
      {
        if (strcmp(aiChksum, "HI8b3tnTtX0PwseiT5YxlC") == 0) {
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "nsag4O0BKnrSXAfMBBRAqD") == 0) {
     ...
     case 2:
      {
        if (strcmp(tpChksum, "pV2jAAo1kz8lxPfjvcIq6C") == 0) {
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "nsag4O0BKnrSXAfMBBRAqD") == 0) {
          extern mxArray *sf_c1_simulation_jit_fallback_info(void);
          plhs[0] = sf_c1_simulation_jit_fallback_info();
          break;
        }
      }
...
void sf_simulation_get_post_codegen_info( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  ...
  switch (chartFileNumber) {
   case 1:
    {
      if (strcmp(tpChksum, "nsag4O0BKnrSXAfMBBRAqD") == 0) {
        extern mxArray *sf_c1_simulation_get_post_codegen_info(void);
        plhs[0] = sf_c1_simulation_get_post_codegen_info();
        return;
      }
    }
    break;
   ...
   case 2:
    {
      if (strcmp(tpChksum, "pV2jAAo1kz8lxPfjvcIq6C") == 0) {
        extern mxArray *sf_c2_simulation_get_post_codegen_info(void);
        plhs[0] = sf_c2_simulation_get_post_codegen_info();
        return;
      }
    }
    break;
