...
static void sf_gateway_c1_simulation(SFc1_simulationInstanceStruct
  *chartInstance);
static void mdl_start_c1_simulation(SFc1_simulationInstanceStruct *chartInstance);
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_simulationInstanceStruct *chartInstance,
  const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_b_y[6]);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_e_emlrt_marshallIn(SFc1_simulationInstanceStruct *chartInstance,
  const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_b_y[3]);
...
static void c1_eml_scalar_eg(SFc1_simulationInstanceStruct *chartInstance);
static void c1_eml_xgemm(SFc1_simulationInstanceStruct *chartInstance, real_T
  c1_A[6], real_T c1_B[3], real_T c1_C[2], real_T c1_b_C[2]);
static const mxArray *c1_f_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_f_emlrt_marshallIn(SFc1_simulationInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_g_emlrt_marshallIn(SFc1_simulationInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_simulation, const char_T
  *c1_identifier);
static uint8_T c1_h_emlrt_marshallIn(SFc1_simulationInstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_eml_xgemm(SFc1_simulationInstanceStruct *chartInstance, real_T
  c1_A[6], real_T c1_B[3], real_T c1_C[2]);
static void init_dsm_address_info(SFc1_simulationInstanceStruct *chartInstance);
static void init_simulink_io_address(SFc1_simulationInstanceStruct
  *chartInstance);
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_simulation = c1_g_emlrt_marshallIn
  ...
  *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_x_body, 0U, c1_e_sf_marshallOut,
    c1_d_sf_marshallIn);
  ...
  const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_b_y[2])
{
  ...
  int32_T c1_i18;
  (void)chartInstance;
  sf_mex_import(c1_parentId, sf_mex_dup(c1_b_u), c1_dv3, 1, 0, 0U, 1, 0U, 1, 2);
  for (c1_i18 = 0; c1_i18 < 2; c1_i18++) {
    c1_b_y[c1_i18] = c1_dv3[c1_i18];
  }
  ...
  *c1_inData)
{
  ...
  for (c1_i20 = 0; c1_i20 < 4; c1_i20++) {
    c1_b_inData[c1_i20] = (*(real_T (*)[4])c1_inData)[c1_i20];
  }
  ...
  *c1_inData)
{
  ...
  for (c1_i23 = 0; c1_i23 < 3; c1_i23++) {
    for (c1_i24 = 0; c1_i24 < 2; c1_i24++) {
      c1_b_inData[c1_i24 + c1_i22] = (*(real_T (*)[6])c1_inData)[c1_i24 + c1_i22];
    }
  ...
  c1_b_y = NULL;
  sf_mex_assign(&c1_b_y, sf_mex_create("y", c1_b_u, 0, 0U, 1U, 0U, 2, 2, 3),
                false);
  sf_mex_assign(&c1_mxArrayOutData, c1_b_y, false);
  return c1_mxArrayOutData;
}
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i30 = 0; c1_i30 < 3; c1_i30++) {
    for (c1_i31 = 0; c1_i31 < 2; c1_i31++) {
      (*(real_T (*)[6])c1_outData)[c1_i31 + c1_i29] = c1_b_y[c1_i31 + c1_i29];
    }
  ...
  *c1_inData)
{
  ...
  for (c1_i33 = 0; c1_i33 < 3; c1_i33++) {
    c1_b_u[c1_i33] = c1_b_inData[c1_i33];
  }
  ...
  const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_b_y[3])
{
  ...
  int32_T c1_i34;
  (void)chartInstance;
  sf_mex_import(c1_parentId, sf_mex_dup(c1_b_u), c1_dv5, 1, 0, 0U, 1, 0U, 1, 3);
  for (c1_i34 = 0; c1_i34 < 3; c1_i34++) {
    c1_b_y[c1_i34] = c1_dv5[c1_i34];
  }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  SFc1_simulationInstanceStruct *chartInstance;
  chartInstance = (SFc1_simulationInstanceStruct *)chartInstanceVoid;
  c1_x_body = sf_mex_dup(c1_mxArrayInData);
  c1_identifier = c1_varName;
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_x_body), &c1_thisId, c1_b_y);
  sf_mex_destroy(&c1_x_body);
  for (c1_i35 = 0; c1_i35 < 3; c1_i35++) {
    (*(real_T (*)[3])c1_outData)[c1_i35] = c1_b_y[c1_i35];
  }
  ...
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId)
{
  ...
  int32_T c1_i39;
  (void)chartInstance;
  sf_mex_import(c1_parentId, sf_mex_dup(c1_b_u), &c1_i39, 1, 6, 0U, 0, 0U, 0);
  c1_b_y = c1_i39;
  sf_mex_destroy(&c1_b_u);
  return c1_b_y;
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3581678851U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2392858930U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1325038718U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2902285366U);
}

mxArray* sf_c1_simulation_get_post_codegen_info(void);
mxArray *sf_c1_simulation_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("dG6vXr0YJ71uaf1qQhpDzC");
  ...
  {
    mxArray* mxPostCodegenInfo = sf_c1_simulation_get_post_codegen_info();
...
mxArray *sf_c1_simulation_jit_fallback_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_simulation(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c1_simulation\",}}"
  };
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc1_simulationInstanceStruct *) chartInfo->chartInstance;
...
{
  sf_gateway_c1_simulation((SFc1_simulationInstanceStruct*) chartInstanceVar);
}
...
static const mxArray* sf_opaque_get_sim_state_c1_simulation(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c1_simulation((SFc1_simulationInstanceStruct*)
...
static void mdlSetWorkWidths_c1_simulation(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1127163766U));
  ssSetChecksum1(S,(3940759242U));
  ssSetChecksum2(S,(2440928594U));
  ssSetChecksum3(S,(202140827U));
