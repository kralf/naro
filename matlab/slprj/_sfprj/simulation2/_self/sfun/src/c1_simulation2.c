...
static const char * c1_debug_family_names[13] = { "Q", "R", "K", "S", "e",
  "u_lqr", "nargin", "nargout", "u", "A", "B", "x", "y" };
...
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_e_emlrt_marshallIn(SFc1_simulation2InstanceStruct *chartInstance,
  const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_b_y[64]);
...
static int32_T c1_intmin(SFc1_simulation2InstanceStruct *chartInstance);
static const mxArray *c1_h_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_f_emlrt_marshallIn(SFc1_simulation2InstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_g_emlrt_marshallIn(SFc1_simulation2InstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_simulation2, const char_T
  *c1_identifier);
static uint8_T c1_h_emlrt_marshallIn(SFc1_simulation2InstanceStruct
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId);
  ...
  *chartInstance, const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_simulation2 = c1_g_emlrt_marshallIn
  ...
  *chartInstance)
{
  ...
  real_T c1_Q[64];
  real_T c1_R[4];
  const mxArray *c1_K = NULL;
  const mxArray *c1_S = NULL;
  const mxArray *c1_e = NULL;
  const mxArray *c1_u_lqr = NULL;
  ...
  int32_T c1_j;
  int32_T c1_b_j;
  static real_T c1_dv1[8] = { 2.0, 2.0, 2.0, 2.0, 2.0, 0.0, 0.0, 0.0 };
  ...
  const mxArray *c1_b_e = NULL;
  const mxArray *c1_b_S = NULL;
  ...
  for (c1_i2 = 0; c1_i2 < 64; c1_i2++) {
    c1_b_A[c1_i2] = (*chartInstance->c1_A)[c1_i2];
  }

  for (c1_i3 = 0; c1_i3 < 16; c1_i3++) {
    c1_b_B[c1_i3] = (*chartInstance->c1_B)[c1_i3];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_R, 1U, c1_g_sf_marshallOut,
    c1_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_K, 2U, c1_f_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_S, 3U, c1_f_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_e, 4U, c1_f_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_u_lqr, 5U, c1_f_sf_marshallOut);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c1_nargout, 7U, c1_e_sf_marshallOut,
    c1_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c1_b_u, 8U, c1_e_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_b_A, 9U, c1_d_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_b_B, 10U, c1_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c1_b_x, 11U, c1_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c1_b_y, 12U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 6);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 9);
  for (c1_i5 = 0; c1_i5 < 64; c1_i5++) {
    c1_Q[c1_i5] = 0.0;
  }
  ...
  for (c1_j = 1; c1_j < 9; c1_j++) {
    c1_b_j = c1_j;
    c1_Q[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c1_b_j), 1, 8, 1, 0) + ((_SFD_EML_ARRAY_BOUNDS_CHECK("",
             (int32_T)_SFD_INTEGER_CHECK("", (real_T)c1_b_j), 1, 8, 2, 0) - 1) <<
           3)) - 1] = c1_dv1[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)
      _SFD_INTEGER_CHECK("", (real_T)c1_b_j), 1, 8, 1, 0) - 1];
  }
  ...
  c1_intmin(chartInstance);
  for (c1_c_j = 1; c1_c_j < 3; c1_c_j++) {
    c1_d_j = c1_c_j;
    c1_R[(_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
            (real_T)c1_d_j), 1, 2, 1, 0) + ((_SFD_EML_ARRAY_BOUNDS_CHECK("",
             (int32_T)_SFD_INTEGER_CHECK("", (real_T)c1_d_j), 1, 2, 2, 0) - 1) <<
           1)) - 1] = 1.0;
  }

  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 13);
  for (c1_i7 = 0; c1_i7 < 64; c1_i7++) {
    c1_c_u[c1_i7] = c1_b_A[c1_i7];
  }

  c1_c_y = NULL;
  sf_mex_assign(&c1_c_y, sf_mex_create("y", c1_c_u, 0, 0U, 1U, 0U, 2, 8, 8),
                false);
  for (c1_i8 = 0; c1_i8 < 16; c1_i8++) {
    c1_d_u[c1_i8] = c1_b_B[c1_i8];
  }

  c1_d_y = NULL;
  sf_mex_assign(&c1_d_y, sf_mex_create("y", c1_d_u, 0, 0U, 1U, 0U, 2, 8, 2),
                false);
  for (c1_i9 = 0; c1_i9 < 64; c1_i9++) {
    c1_e_u[c1_i9] = c1_Q[c1_i9];
  }

  c1_e_y = NULL;
  sf_mex_assign(&c1_e_y, sf_mex_create("y", c1_e_u, 0, 0U, 1U, 0U, 2, 8, 8),
                false);
  for (c1_i10 = 0; c1_i10 < 4; c1_i10++) {
    c1_f_u[c1_i10] = c1_R[c1_i10];
  }

  c1_f_y = NULL;
  sf_mex_assign(&c1_f_y, sf_mex_create("y", c1_f_u, 0, 0U, 1U, 0U, 2, 2, 2),
                false);
  sf_mex_call_debug(sfGlobalDebugInstanceStruct, "lqr", 3U, 4U, 14, c1_c_y, 14,
                    c1_d_y, 14, c1_e_y, 14, c1_f_y, &c1_b_K, &c1_b_S, &c1_b_e);
  sf_mex_assign(&c1_K, sf_mex_dup(c1_b_K), false);
  sf_mex_assign(&c1_S, sf_mex_dup(c1_b_S), false);
  sf_mex_assign(&c1_e, sf_mex_dup(c1_b_e), false);
  _SFD_EML_CALL(0U, chartInstance->c1_sfEvent, 15);
  for (c1_i11 = 0; c1_i11 < 8; c1_i11++) {
    c1_g_u[c1_i11] = c1_b_x[c1_i11];
  }

  c1_g_y = NULL;
  sf_mex_assign(&c1_g_y, sf_mex_create("y", c1_g_u, 0, 0U, 1U, 0U, 1, 8), false);
  sf_mex_assign(&c1_u_lqr, sf_mex_call_debug(sfGlobalDebugInstanceStruct,
    "mtimes", 1U, 2U, 14, sf_mex_dup(c1_K), 14, c1_g_y), false);
  ...
  for (c1_i13 = 0; c1_i13 < 2; c1_i13++) {
    c1_h_u[c1_i13] = c1_b_y[c1_i13];
  }

  c1_h_y = NULL;
  sf_mex_assign(&c1_h_y, sf_mex_create("y", c1_h_u, 0, 0U, 1U, 0U, 1, 2), false);
  ...
  for (c1_i16 = 0; c1_i16 < 64; c1_i16++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c1_A)[c1_i16], 2U);
  }

  for (c1_i17 = 0; c1_i17 < 16; c1_i17++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c1_B)[c1_i17], 3U);
  }

  for (c1_i18 = 0; c1_i18 < 8; c1_i18++) {
    _SFD_DATA_RANGE_CHECK((*chartInstance->c1_x)[c1_i18], 4U);
  }
}
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  for (c1_i19 = 0; c1_i19 < 2; c1_i19++) {
    c1_b_inData[c1_i19] = (*(real_T (*)[2])c1_inData)[c1_i19];
  }

  for (c1_i20 = 0; c1_i20 < 2; c1_i20++) {
    c1_b_u[c1_i20] = c1_b_inData[c1_i20];
  }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i22 = 0; c1_i22 < 2; c1_i22++) {
    (*(real_T (*)[2])c1_outData)[c1_i22] = c1_c_y[c1_i22];
  }
  ...
  *c1_inData)
{
  ...
  for (c1_i23 = 0; c1_i23 < 8; c1_i23++) {
    c1_b_inData[c1_i23] = (*(real_T (*)[8])c1_inData)[c1_i23];
  }

  for (c1_i24 = 0; c1_i24 < 8; c1_i24++) {
    c1_b_u[c1_i24] = c1_b_inData[c1_i24];
  }

  c1_b_y = NULL;
  sf_mex_assign(&c1_b_y, sf_mex_create("y", c1_b_u, 0, 0U, 1U, 0U, 1, 8), false);
  sf_mex_assign(&c1_mxArrayOutData, c1_b_y, false);
  return c1_mxArrayOutData;
}
  ...
  *c1_inData)
{
  ...
  for (c1_i26 = 0; c1_i26 < 2; c1_i26++) {
    for (c1_i27 = 0; c1_i27 < 8; c1_i27++) {
      c1_b_inData[c1_i27 + c1_i25] = (*(real_T (*)[16])c1_inData)[c1_i27 +
        c1_i25];
    }
  ...
  for (c1_i29 = 0; c1_i29 < 2; c1_i29++) {
    for (c1_i30 = 0; c1_i30 < 8; c1_i30++) {
      c1_b_u[c1_i30 + c1_i28] = c1_b_inData[c1_i30 + c1_i28];
    }
  ...
  c1_b_y = NULL;
  sf_mex_assign(&c1_b_y, sf_mex_create("y", c1_b_u, 0, 0U, 1U, 0U, 2, 8, 2),
                false);
  sf_mex_assign(&c1_mxArrayOutData, c1_b_y, false);
  return c1_mxArrayOutData;
}
  ...
  *c1_inData)
{
  ...
  for (c1_i32 = 0; c1_i32 < 8; c1_i32++) {
    for (c1_i33 = 0; c1_i33 < 8; c1_i33++) {
      c1_b_inData[c1_i33 + c1_i31] = (*(real_T (*)[64])c1_inData)[c1_i33 +
        c1_i31];
    }
  ...
  for (c1_i35 = 0; c1_i35 < 8; c1_i35++) {
    for (c1_i36 = 0; c1_i36 < 8; c1_i36++) {
      c1_b_u[c1_i36 + c1_i34] = c1_b_inData[c1_i36 + c1_i34];
    }
  ...
  c1_b_y = NULL;
  sf_mex_assign(&c1_b_y, sf_mex_create("y", c1_b_u, 0, 0U, 1U, 0U, 2, 8, 8),
                false);
  sf_mex_assign(&c1_mxArrayOutData, c1_b_y, false);
  return c1_mxArrayOutData;
}
  ...
  *c1_inData)
{
  ...
  c1_b_y = NULL;
  sf_mex_assign(&c1_b_y, sf_mex_duplicatearraysafe(&c1_b_u), false);
  sf_mex_destroy(&c1_b_u);
  sf_mex_assign(&c1_mxArrayOutData, c1_b_y, false);
  return c1_mxArrayOutData;
}
  ...
  *c1_inData)
{
  ...
  for (c1_i38 = 0; c1_i38 < 2; c1_i38++) {
    for (c1_i39 = 0; c1_i39 < 2; c1_i39++) {
      c1_b_inData[c1_i39 + c1_i37] = (*(real_T (*)[4])c1_inData)[c1_i39 + c1_i37];
    }
  ...
  for (c1_i41 = 0; c1_i41 < 2; c1_i41++) {
    for (c1_i42 = 0; c1_i42 < 2; c1_i42++) {
      c1_b_u[c1_i42 + c1_i40] = c1_b_inData[c1_i42 + c1_i40];
    }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_R), &c1_thisId, c1_b_y);
  sf_mex_destroy(&c1_R);
  c1_i44 = 0;
  for (c1_i45 = 0; c1_i45 < 2; c1_i45++) {
    for (c1_i46 = 0; c1_i46 < 2; c1_i46++) {
      (*(real_T (*)[4])c1_outData)[c1_i46 + c1_i44] = c1_b_y[c1_i46 + c1_i44];
    }
  ...
  const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId, real_T c1_b_y[64])
{
  ...
  int32_T c1_i47;
  (void)chartInstance;
  sf_mex_import(c1_parentId, sf_mex_dup(c1_b_u), c1_dv4, 1, 0, 0U, 1, 0U, 2, 8,
                8);
  for (c1_i47 = 0; c1_i47 < 64; c1_i47++) {
    c1_b_y[c1_i47] = c1_dv4[c1_i47];
  }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup(c1_Q), &c1_thisId, c1_b_y);
  sf_mex_destroy(&c1_Q);
  c1_i48 = 0;
  for (c1_i49 = 0; c1_i49 < 8; c1_i49++) {
    for (c1_i50 = 0; c1_i50 < 8; c1_i50++) {
      (*(real_T (*)[64])c1_outData)[c1_i50 + c1_i48] = c1_b_y[c1_i50 + c1_i48];
    }
...
static void c1_info_helper(const mxArray **c1_info)
{
  ...
  sf_mex_addfield(*c1_info, c1_emlrt_marshallOut("disp"), "name", "name", 12);
  ...
  *chartInstance, const mxArray *c1_b_u, const emlrtMsgIdentifier *c1_parentId)
{
  ...
  int32_T c1_i51;
  (void)chartInstance;
  sf_mex_import(c1_parentId, sf_mex_dup(c1_b_u), &c1_i51, 1, 6, 0U, 0, 0U, 0);
  c1_b_y = c1_i51;
  sf_mex_destroy(&c1_b_u);
  return c1_b_y;
}
  ...
  *c1_identifier)
{
  ...
  c1_thisId.fIdentifier = c1_identifier;
  c1_thisId.fParent = NULL;
  c1_b_y = c1_h_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_y = (real_T (*)[2])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c1_A = (real_T (*)[64])ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c1_B = (real_T (*)[16])ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c1_x = (real_T (*)[8])ssGetInputPortSignal_wrapper
    (chartInstance->S, 3);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2087823733U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(490090645U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(105526165U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(924096796U);
}
...
mxArray *sf_c1_simulation2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("cFpYH7hFNK9O8ftGVYPbk");
...
static const mxArray *sf_get_sim_state_info_c1_simulation2(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c1_simulation2\",}}"
  };
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(2U, *chartInstance->c1_A);
        _SFD_SET_DATA_VALUE_PTR(3U, *chartInstance->c1_B);
...
static void mdlSetWorkWidths_c1_simulation2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3797870442U));
  ssSetChecksum1(S,(3377915917U));
  ssSetChecksum2(S,(2017889219U));
  ssSetChecksum3(S,(1868078960U));
